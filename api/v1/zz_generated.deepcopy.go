...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExclusiveCPUInfo) DeepCopyInto(out *ExclusiveCPUInfo) {
	*out = *in
	if in.PowerContainer != nil {
		in, out := &in.PowerContainer, &out.PowerContainer
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExclusiveCPUInfo.
func (in *ExclusiveCPUInfo) DeepCopy() *ExclusiveCPUInfo {
	if in == nil {
		return nil
	}
	out := new(ExclusiveCPUInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ExclusiveCPUPoolStatus) DeepCopyInto(out *ExclusiveCPUPoolStatus) {
	*out = *in
	if in.ExclusiveCPUInfo != nil {
		in, out := &in.ExclusiveCPUInfo, &out.ExclusiveCPUInfo
		*out = make([]ExclusiveCPUInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
